...
class EvidenceFactory:
    ...
    def build(
        ...
        *,
        ...
        """Build evidence pack for one EventNode.

        Methods:
        - montage: plain keyframe montage
        - overlay: overlay + crop + trajectory visualization
        """
